      ...
      builder: (context, currentState) {
        ...
        if (currentState is ItemCardInitial) {
          ...
          if(currentState.fromWishlist) {
            ...
            HiveStore().reset();
            context.read<HomeScreenBloc>().add(const HomeScreenDataFetchEvent(true));
            // itemCardBloc?.emit(WishlistIdleState());
              ...
              Stack(children: <Widget>[
                Container(
                  width: (AppSizes.deviceWidth -
                      ...
                      2.5,
                  height: constrains.maxHeight*.7,                  decoration: ShapeDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      (widget.callBack != null)
                          ? ((widget.product?.typeId.toString() == "simple") ?? false)
                              ? Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Checkbox(
                                        value:
                                            widget.product?.isChecked ?? widget.isSelected,
                                        onChanged: (value) {
                                          setState(() {
