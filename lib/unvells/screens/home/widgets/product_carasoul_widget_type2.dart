                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      if (!(mainBox.containsKey("ProductPageData:${data.entityId ?? 0}" ?? ""))) {
                        precCacheProductPage((data.entityId ?? 0).toString() ?? "");
                        // precCacheProductPageNew(("GIFT-HBD" ?? 0).toString() ?? "");
                      }
                      return ItemCard(
                        product: data,
                        imageSize: (AppSizes.deviceWidth - (AppSizes.size8 + AppSizes.size8)) / 2.5,
                        isSelected: false,
