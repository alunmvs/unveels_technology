...
class DialogHelper {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: <Widget>[
          ...
          CustomButton(
            ...
            hieght: AppSizes.deviceWidth * .1,
            title: (localizations?.translate(AppStringConstant.ok) ?? "").toUpperCase(),
          ),
        ],
      ),
    );
        ...
        actions: <Widget>[
          CustomButton(
            ...
            title: GenericMethods.getStringValue(
                context, AppStringConstant.tryAgain).toUpperCase(),
          ),
        ],
      ),
    );
  ...
  static deleteAccountConfirmationDialog(BuildContext context, String title,
    ...
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(title, style: KTextStyle.of(context).semiBoldSixteen.copyWith(color: AppColors.gold),),
        content: Form(
          key: _formKey,
          child: Column(
            mainAxisSize: MainAxisSize.min,
